"""
Django settings for kissan_market project.
...
SECRET_KEY = 'django-insecure-m(qx%j0c^uxkg(*!g5s#603-_7t_il58$w4@c@r^&z420lb-t5'
...
ROOT_URLCONF = 'kissan_market.urls'
...
# settings.py
AUTH_USER_MODEL = 'registration_login_system.User'
