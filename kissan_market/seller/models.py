...
class TransactionRecord(models.Model):
    ...
    buyer = models.CharField(max_length=255)      # email
    seller = models.CharField(max_length=255)     # email
    ...
    created_at = models.CharField(max_length=50)   # storing as string exactly how you formatted

    saved_on = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f" - {self.vegetable_name}"
